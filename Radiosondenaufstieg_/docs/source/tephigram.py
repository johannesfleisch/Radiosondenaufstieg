...
Description: Short program to plot a Tephigram, which includes a temperature and humidity line. In the second part a geographical map is plotted, which shows the ascent point of the radiosonde.
"""
